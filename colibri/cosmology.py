...
class cosmo:
    ...
    # f(R) enhancement
    #-------------------------------------------------------------------------------
    def fR_correction(self, k, z, f_R0):
        """
        Enhancement of the non-linear matter power spectrum due to f(R) gravity. The formula used is from Winther et al. (2019)
        ...
        #else: 
        #    raise ValueError("f_R0 out of bounds, choose between 1e-7 and 1e-4.")
        return enhancement
