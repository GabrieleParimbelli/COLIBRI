...
class angular_spectra():
    ...
    def compute_shear_spectra(self, l, **kwargs):
        """
        This function calls :func:`~colibri.angular_spectra.compute_angular_power_spectra` and computes the shear angular power spectra.
        ...
        """
        Cl = self.compute_angular_power_spectra(l = l, do_WL = True, do_IA = True, do_GC = False, **kwargs)
        return Cl['LL']

    def compute_galaxy_clustering_spectra(self, l):
        """
        This function calls :func:`~colibri.angular_spectra.compute_angular_power_spectra` and computes the galaxy clustering angular power spectra.
        ...
        """
        Cl = self.compute_angular_power_spectra(l = l, do_WL = False, do_IA = False, do_GC = True)
        return Cl['GG']

    def compute_galaxy_galaxy_lensing_spectra(self, l, **kwargs):
        """
        This function calls :func:`~colibri.angular_spectra.compute_angular_power_spectra` and computes the galaxy-galaxy lensing angular power spectra.
        It assumes that IA is included.
        ...
        """
        Cl = self.compute_angular_power_spectra(l = l, do_WL = True, do_IA = True, do_GC = True, **kwargs)
        return Cl['GL']
